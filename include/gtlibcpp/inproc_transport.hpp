/*
 * In-process transport for tests and headless agents. Two endpoints
 * share an internal queue pair: a writer on one side and a reader on
 * the other. Identical to a named pipe from the agent's point of view.
 */
#pragma once
